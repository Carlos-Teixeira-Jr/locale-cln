      ...
      <div className="flex justify-center max-w-[1000px] my-20">
        <div className="text-xl m-auto">
          <div className="flex flex-col items-center mt-2">
            ...
            <p className="mt-1">
              Última atualização <b>03/03/2023</b>
            </p>
          </div>

          <div className="my-10">
            <div className="ml-4 mb-10">
              <h2 className="font-bold mb-6">Política Privacidade</h2>
              <p className="text-justify">
                A sua privacidade é importante para nós. É política do Locale
                Imóveis respeitar a sua privacidade em relação a qualquer
                informação sua que possamos coletar no site Locale Imóveis, e
                outros sites que possuímos e operamos. <br />
                ...
                serviços desejados. <br />O uso continuado de nosso site será
            ...
            <div className="ml-4 mb-10">
              <h2 className="font-bold mb-6">Política de Cookies Locale</h2>
              <p className="font-medium mb-6">O que são cookies?</p>
              ...
              <p className="font-medium mb-6">Como usamos os cookies?</p>
              <p className="text-justify mb-6">
              ...
              <p className="font-medium mb-6">Desativar cookies</p>
              <p className="text-justify mb-6">
              ...
              <p className="font-medium mb-6">Cookies que definimos</p>
              <li className="mb-6">Cookies relacionados à conta</li>
              <p className="text-justify ml-20 mb-6">
              ...
              <li className="mb-6">Cookies relacionados ao login</li>
              <p className="text-justify ml-20 mb-6">
              ...
              <li className="mb-6">Pedidos processando cookies relacionados</li>
              <p className="text-justify ml-20 mb-6">
              ...
              <li className="mb-6">Cookies relacionados a pesquisas</li>
              <p className="text-justify ml-20 mb-6">
              ...
              <li className="mb-6">Cookies relacionados a formulários</li>
              <p className="text-justify ml-20 mb-6">
              ...
              <li className="mb-6">Cookies de preferências do site</li>
              <p className="text-justify ml-20 mb-6">
              ...
              <h2 className="font-bold mb-6">Cookies de Terceiros</h2>
              ...
              <li className="mb-6 text-justify ml-20">
                Este site usa o <u>Google Analytics</u>, que é uma das soluções
                de análise mais difundidas e confiáveis ​​da Web, para nos
                ajudar a entender como você usa o site e como podemos melhorar
                sua experiência. Esses cookies podem rastrear itens como quanto
              ...
              <h2 className="font-bold mb-6 text-justify">
                Cookies de Terceiros
              </h2>
              <p className="mb-6 text-justify">
                O usuário se compromete a fazer uso adequado dos conteúdos e da
                informação que o Locale Imóveis oferece no site e com caráter
              ...
              <li className="mb-6 text-justify ml-20">
                ...
                (softwares) do Locale Imóveis, de seus fornecedores ou
              ...
              <h2 className="font-bold mb-6">Mais informações</h2>
              <p className="mb-6 text-justify">
              ...
              <p className="mb-6">
                Esta política é efetiva a partir de <b>Mar/2023</b>.
              </p>
            </div>
          </div>
        </div>
