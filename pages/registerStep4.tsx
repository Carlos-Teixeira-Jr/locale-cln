            ...
            <div className={classes.body}>
              <div className={classes.textContainer}>
                ...
                <p className={classes.p}>
                  Seu anúncio de imóvel está pronto e o seu cadastro está quase finalizado! Se você acabou de criar sua conta ao cadastrar o anúncio, uma senha temporária será enviada para o seu e-mail. 😊
                </p>
