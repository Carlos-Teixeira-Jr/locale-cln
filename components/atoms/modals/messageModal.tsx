    ...
    >
      <div className="bg-quinary">
        <h1 className="lg:w-fit lg:h-fit m-[5px] mt-0 font-bold md:text-2xl text-quaternary">
          Mande uma mensagem para {formData.nameA}
        </h1>
        <input type="text" name="_id" value={formData._id} hidden />
        ...
        <div className="flex flex-col">
          ...
          <textarea
            className="mx-2 mb-0 border border-quaternary mt-1 lg:w-[770px] w-[250px] sm:w-full lg:h-[44px] bg-tertiary rounded-[10px] p-2 required:border-red-500 text-xl text-quaternary font-semibold"
            name="message"
            value={formData.message}
            placeholder={`Olá, gostaria de mais informações a respeito do imóvel ${announcementCode}.`}
            onChange={(event) =>
