export default function CheckedIcon() {
  return (
    <svg
      ...
      viewBox="0 0 66 66"
    >
      <circle cx="33" cy="33" r="33" fill="#4BB543"></circle>
      <mask
        id="mask0_826_558"
      ...
      >
        <path fill="url(#pattern0)" d="M15 15H51V51H15z"></path>
      </mask>
      <g mask="url(#mask0_826_558)">
        <path fill="#fff" d="M12 13H54V51H12z"></path>
      </g>
      <defs>
        <pattern
          id="pattern0"
        ...
        >
          <use transform="scale(.00195)" xlinkHref="#image0_826_558"></use>
        </pattern>
        <image
          id="image0_826_558"
          width="512"
