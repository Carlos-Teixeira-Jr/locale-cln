export default function AdvertiseIcon({ fill = "currentColor", width = "24", height = "24", className = "" }) {
  return (
    <svg fill={fill} height={height} width={width} className={className} version="1.1" id="XMLID_264_" xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24" >
      <g id="announcement">
        <g>
