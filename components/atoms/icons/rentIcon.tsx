export default function RentIcon({ fill = "currentColor", width = "30", height = "30", className = "" }) {
  return (
    <svg fill={fill} height={height} className={className} width={width} version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
      viewBox="-77 65 101 128">
