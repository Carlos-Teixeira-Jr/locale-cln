export default function MessageBalloonIcon({fill = "currentColor", className="", viewBox="0 96 960 960"}) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill={fill} height="44" width="44" viewBox={viewBox} className={className}>
