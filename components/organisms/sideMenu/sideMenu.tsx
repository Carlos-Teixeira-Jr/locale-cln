      ...
      icon: (
        <div className="flex items-center justify-around ">
          <BellIcon
            ...
            height="35"
          />
          <div className="absolute top-100 mt-4 ml-2 left-10">
            <div
              data-nots={notifications.length}
              id={'notifications-value'}
              className="before:content-[attr(data-nots)] before:text-xs before:bg-tertiary before:font-medium before:text-primary before:border-secondary before:rounded-full before:border before:flex before:items-center before:justify-center before:min-w-[1.5em] before:min-h-[0.5em]"
            ></div>
          </div>
        </div>
      ),
                ...
                <Link href={link} key={key}>
                  <div key={key}>
                    ...
                    >
                      {icon}
                      <h2
                        className={`text-xl font-bold leading-7 my-auto ${
                          activeButton === id
                            ? 'text-secondary'
                            : 'text-quaternary'
                        }`}
