      ...
      <div className="container p-6 m-auto bg-tertiary max-w-none">
        <div className="grid lg:grid-cols-4 md:grid-cols-2">
          <div className="mx-auto pb-5">
            <h5 className="font-bold mb-2.5 text-gray-800 flex justify-center">ENCONTRE IMÓVEIS</h5>
          ...
          <div className="mx-auto pb-5">
            <h5 className="font-bold mb-2.5 text-gray-800 flex justify-center">ANUNCIE IMÓVEIS</h5>
          ...
          <div className="mx-auto pb-5">
            <h5 className="uppercase font-bold mb-2.5 text-gray-800 flex justify-center">
              INSTITUCIONAL
            </h5>
