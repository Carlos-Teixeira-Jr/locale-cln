...
const PropertyInfoCard: React.FC<IPropertyInfoCard> = ({
  ...
  return (
    <>
      <Link href={href}>
        <div className="md:w-[760px] md:h-[265px] bg-tertiary md:grid md:grid-cols-3 rounded-[30px] overflow-hidden drop-shadow-lg my-[29px] md:mx-[35px] mx-2 flex flex-col md:max-w-full">
