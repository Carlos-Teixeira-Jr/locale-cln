import { PricesType } from '../../../../common/interfaces/property/propertyData';
...
const base: IPropertyCard = {
  ...
  description:
    'Cobertura duplex no pedacinho mais privilegiado da Saúde! A cobertura se divide em dois pavimentos, tendo seu acesso pelo piso inferior, que abriga a sala, terraço, cozinha e área',
  bedrooms: 3,
  bathrooms: 2,
  parking_spaces: 2,
  images: [
